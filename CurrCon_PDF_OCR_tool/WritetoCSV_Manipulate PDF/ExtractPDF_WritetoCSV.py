...
while infinity == '': # infiinite while loop
    def savetext(inputvalue,savedvalue,index,): #save previous text for the next round of metadata input
        ...
        return inputvalue
# Prompts
    FilepathofOriginal='M:\Engineering\Drawing Inventory\Drawings to be filed\LRT 434A\LRT-434A.pdf'
    ...
    if drawing1 == drawing2:
        ...
        notation=savetext(notation,savedvalue,5)
        notation1=raw_input("What letter(s) does the new drawing number end with?")
        lastdnumber=input("What is the last drawing number?") # Set first drawing number
...
# Record category into hyperlinks.csv, by knowing the filepath directory. 
    ...
    while drawing1 <= drawing2: 
        ...
        New_string=Generalname+'_'+notation+str(firstdnumber)+notation1+'.pdf' # Modify string name
        ...
        additional_line=['=HYPERLINK('+'"'+NewFilename+'"'+','+'"'+New_string+'")'+';'+'7/18/96'+';'+ 'MTS Rail'+';'+ Line_segment+';'+'Segment(Hidden)'+';'+Main_cat+';'+ \
            Sub_cat+';'+'Conformed'+';'+Generalname+';'+notation+str(firstdnumber)+notation1+';'+Drawing_title+';'+Engineer_of_record+';'+From+';'+To+';;;;']
