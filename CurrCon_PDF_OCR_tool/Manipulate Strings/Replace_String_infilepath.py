...
Folder=input("What directory are you working in?(Put input in single quotes)") # Must input a string with apostrophes
print Folder
Old_string=input("What strings of filename do you want to replace?(Put input in single quotes)")
print Old_string
New_string=input("What do you want the old string to be replaced with?(Put input in single quotes)")
print New_string
